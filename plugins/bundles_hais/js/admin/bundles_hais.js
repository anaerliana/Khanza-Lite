...
$("#bundles_maintanance").on("click", "#simpan_maintanance", function(event){
  ...
  $.post(url, {
    ...
    $('input:text[name=tanggalbundles]').val("");
...
$("#bundles_ido").on("click", "#simpan_ido", function(event){
  ...
  console.log({
   ...
   var url = baseURL + '/bundles_hais/saveido?t=' + mlite.token;
  $.post(url, {
    no_rawat : no_rawat,
    tanggal : tanggal,
    kd_kamar : kd_kamar,
    ...
    console.log(data);
    // tampilkan data
     var url = baseURL + '/bundles_hais/bundles_ido/'+no_rawat+'?t=' + mlite.token;
    // var url = baseURL + '/bundles_hais/bundles_ido?t=' + mlite.token;
    $.post(url, {
      // no_rawat : no_rawat,
    }, function(data) {
      // $("#ido").load(baseURL + " #ido");
      // tampilkan data
      console.log(data);
      $("#bundles_ido").html(data).show();
      // $("#bundles_ido").load(baseURL + '/bundles_hais/bundles_ido' + mlite.token);
