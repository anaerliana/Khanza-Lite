...
return [
    ...
    'install'       =>  function () use ($core) {
        ...
        $db()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite_vedika` (
          `id` int(11) NOT NULL,
        ...
        $db()->pdo()->exec("ALTER TABLE `mlite_vedika`
          ADD PRIMARY KEY (`id`);");

        $db()->pdo()->exec("ALTER TABLE `mlite_vedika`
          MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;");

        $db()->pdo()->exec("CREATE TABLE IF NOT EXISTS `mlite_vedika_feedback` (
          `id` int(11) NOT NULL,
          `nosep` varchar(100) NOT NULL,
          `tanggal` date DEFAULT NULL,
          `catatan` TEXT,
        ...
        $db()->pdo()->exec("ALTER TABLE `mlite_vedika_feedback`
          ADD PRIMARY KEY (`id`);");
